        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                    ...
                    <form class="form-horizontal" id="xg_form">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <shiro:principal property="adminname"></shiro:principal> 
                                </span>
                            </div>
                        </div>
                        <div class="form-group">
                ...
                <div class="modal-footer">
                    <input type="hidden"
                        value="<shiro:principal  property='id'></shiro:principal>"
                        name="id">
		...
		<div class="container-fluid">
			...
			<div id="navbar" class="collapse navbar-collapse">
				...
				<ul class="nav navbar-nav navbar-right">
                 ...
                 ${sessionScope.admin.adminpower=="1"?"超级管理员":"普通管理员" }:
                    <shiro:principal property="adminname"></shiro:principal>&nbsp;
                    <span class="caret"></span></a>

						<ul class="dropdown-menu" role="menu">
							<li><a href="javascript:$('#xg_model').modal('show');$('#xg_form')[0].reset();"> <span
									class="glyphicon glyphicon-edit"></span> 改 密
							</a></li>
							<li class="divider"></li>
			...
			<ul class="nav">
				<li>
					...
					<p style="text-align: center;">
						<img alt="" src="static/img/icon.jpg"
							style="width: 100px; height: 100px; border-radius: 50px; margin-top: 20px;">
						<br> <span style="color: #999; line-height: 50px;">管理员:
							  <shiro:principal property="adminname"></shiro:principal>
						</span>
					</p>
				</li>
				...
				<li class="has-sub"><a href="javascript:void(0);"><span><span class="glyphicon glyphicon-tasks"></span> 任务管理</span><span style="float: right;"
					...
					<ul class="sub-menu">
						<li><a href="${path}/t"><i class="glyphicon glyphicon-list-alt"></i>任务列表</a></li>
						<li><a id="f1"  href="f1"><i class="glyphicon glyphicon-menu-hamburger"></i>发布任务</a></li>
					</ul></li>
