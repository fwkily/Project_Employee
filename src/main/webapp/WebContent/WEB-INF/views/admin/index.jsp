...
<div class="container-fluid">
  ...
  <div class="row placeholders">
            <div class="col-xs-6 col-sm-3 placeholder">
                <h4>员工人数</h4>
                <span class="text-muted" id="empC">0 条</span>
            </div> 
            <div class="col-xs-6 col-sm-3 placeholder">
                <h4>部门数量</h4>
                <span class="text-muted" id="deptC">0 条</span>
            </div>
            <div class="col-xs-6 col-sm-3 placeholder">
                <h4>任务数量</h4> 
                <span class="text-muted" id="taskC">0 条</span>
            </div>
        ...
        <div class="table-responsive">
            <table class="table table-striped table-hover">
                <tbody>
                    <tr>
                        <td>登录者: <span> <shiro:principal property="adminname"></shiro:principal> </span>
                        </td> 
                    </tr>
                    <tr>
                        <td>你的权限:<span>
